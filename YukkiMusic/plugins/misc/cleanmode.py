...
async def braodcast_message(client, message, _):
    ...
    if message.reply_to_message:
        ...
        if len(message.command) < 2:
            return await message.reply_text("**• استخدم الامر كذا ياعيني ..\nاذاعه + الرسالة او بالرد على الرسالة**")
        ...
        if query == "":
            return await message.reply_text("**• لازم تحط احد الخيارات ياعيني**")
    ...
    if message.chat.id != config.LOG_GROUP_ID:
        try:
            await app.send_message(
                config.LOG_GROUP_ID,
                f"{message.from_user.mention} يستخدم امر الاذاعة في {message.chat.title}",
            )
        except:
            pass

    await message.reply_text(
        "**• تم بدء الاذاعة .. اذا كانت الاذاعه رسالة معاد توجيهها لا تحذف الرسالة ما بتشتغل الاذاعة !**"
    )
    ...
    if "-nobot" not in message.text:
        ...
        for i in chats:
            try:
                ...
                continue
        try:
            await message.reply_text(f"•** تم الاذاعة في {sent} مجموعة مع {pin} تثبيت**")
        except:
            pass
    ...
    if "-user" in message.text:
        ...
        for i in served_users:
            try:
                ...
                pass
        try:
            await message.reply_text("**• تم الاذاعة لـ {susr} شخص**")
        except:
            pass

    # Bot broadcasting by assistant
    if "-assistant" in message.text:
        aw = await message.reply_text("**• تم بدء الاذاعة في الحسابات المساعدة ..**")
        text = "**• اذاعة المساعدات :**\n\n"
        ...
        for num in assistants:
            ...
            async for dialog in client.iter_dialogs():
                try:
                    ...
                    print(e)
                    continue
            text += f"•** الحساب المساعد {num} اذاع في {sent} مجموعة ..**"
        try:
